...
from src.gmail_ml_client.gmail_client import ensure_label, modify_labels, trash_message
from src.gmail_ml_client.sorter import propose
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--no-dry-run", action="store_true", help="Actually move emails (default is dry-run)"
    )
    parser.add_argument(
        "--limit", type=int, default=100, help="Maximum emails to process (default: 100)"
    )
