...
from gmail_client import list_messages, get_message, get_labels, modify_labels
        ...
        try:
            ...
            for i, msg in enumerate(messages, 1):
                try:
                    ...
                    print(f"   📋 Action: Add '{prediction}', Remove from INBOX: {len(labels_to_remove) > 0}")
...
def main():
    ...
    parser.add_argument('--live', action='store_true', help='Actually move emails (default is dry-run)')
    parser.add_argument('--limit', type=int, default=50, help='Number of emails to process (default: 50)')
