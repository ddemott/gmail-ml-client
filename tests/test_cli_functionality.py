...
def test_cli_commands():
    ...
    elif "credentials.json not found" in error or "credential" in error.lower():
        print("✓ init command fails appropriately (no credentials)")
    else:
    ...
    if success:
        ...
        print("✓ ensure-labels command fails appropriately (no credentials)")
    else:
...
def main():
    ...
    if not os.path.exists("scripts/cli.py"):
        print("✗ scripts/cli.py not found")
        return False
