...
class TestDataStore:
    ...
    def setup_method(self):
        ...
        def mock_upsert_message(msg_id: str, snippet: str, text: str) -> None:
            ...
            from src.gmail_ml_client.interfaces import EmailMessage
...
class TestModel:
    ...
    @patch("src.gmail_ml_client.model.keras")
    @patch("src.gmail_ml_client.model.joblib.load")
    ...
    @patch("src.gmail_ml_client.model.keras")
    @patch("src.gmail_ml_client.model.os.path.exists", return_value=False)
...
class TestSorter:
    ...
    @patch("src.gmail_ml_client.sorter.fetch_for_prediction")
...
class TestGmailClient:
    ...
    @patch("src.gmail_ml_client.gmail_client.build")
    ...
    @patch("src.gmail_ml_client.gmail_client.get_service")
