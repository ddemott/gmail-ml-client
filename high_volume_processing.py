    ...
    try:
        ...
        try:
            ...
            for i in range(0, len(messages), batch_size):
                ...
                # Commit batch
                session.commit()
                print(f"   ✅ Batch complete: {batch_processed} processed, {len(batch) - batch_processed} already done")
            ...
            print(f"📊 Processing efficiency: {((classified + new_classifications) / len(messages) * 100):.1f}%")
