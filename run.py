...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            # Run Demo Mode
            run_command(
                ".venv\\Scripts\\python.exe test_e2e_functionality.py",
            ...
            run_command(
                ".venv\\Scripts\\python.exe test_core_functionality.py",
            ...
            # Run All Tests
            run_command(
                ".venv\\Scripts\\python.exe -m pytest test_solid.py test_core_functionality.py test_e2e_functionality.py -v",
                "Running All Tests"
            )
