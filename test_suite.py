...
from test_mocks import (
    MockGmailApi, MockDatabase, MockFileSystem, MockModel,
    MockTextProcessor, MockConfiguration, MockLogger
)
...
class TestPredictionService:
    ...
    def test_predict_messages_success(self, setup_test_dependencies):
        ...
        service = TestablePredictionService(
            mocks['database'], mocks['model'], mocks['text_processor'],
            mocks['config'], mocks['logger']
        )
...
class TestTrainingService:
    ...
    def test_train_model_success(self, setup_test_dependencies):
        ...
        service = TestableTrainingService(
            mocks['database'], mocks['model'], mocks['text_processor'],
            mocks['file_system'], mocks['config'], mocks['logger']
        )
