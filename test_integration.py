...
from testable_services import (
    TestableGmailService, TestablePredictionService, 
    TestableTrainingService, TestableActionService
)
...
class TestEmailProcessingWorkflow:
    ...
    def test_prediction_workflow(self, mock_predict):
        ...
        mock_predict.side_effect = [
            [0.1, 0.9],  # Work email: low spam, high work
            [0.95, 0.05]  # Spam email: high spam, low work
        ]
...
class TestTestableServicesIntegration:
    ...
    def test_email_sync_to_prediction_workflow(self):
        ...
        # 2. Sync emails using TestableGmailService
