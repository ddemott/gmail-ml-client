...
def main():
    try:
        ...
        for i, label in enumerate(useful_folders, 1):
            ...
            elif any(priority in label_name.lower() for priority in ['finance', 'health', 'family', 'computer']):
        ...
        for spam_label in spam_folders:
            ...
            print(f"   📧 Found {len(messages)} SPAM messages (limit: {max_spam_messages}), processing...")
