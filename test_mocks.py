...
class MockGmailApi(GmailApiInterface):
    ...
    def __init__(self):
        ...
        self.labels = [
            LabelInfo(id="label_1", name="INBOX", type="system", messages_total=100, messages_unread=5),
            LabelInfo(id="label_2", name="Work", type="user", messages_total=50, messages_unread=2),
            LabelInfo(id="label_3", name="Personal", type="user", messages_total=30, messages_unread=1),
        ]
        self.messages = {
            "msg_1": EmailMessage(
                id="msg_1",
    ...
    def modify_message_labels(self, message_id: str, add_labels: List[str], remove_labels: List[str]) -> bool:
...
class MockDatabase(DatabaseInterface):
    ...
    def get_messages_for_training(self, limit: Optional[int] = None) -> List[EmailMessage]:
        ...
        reviewed_messages = [
            ...
            if msg_id in self.reviewed_messages
        ]
    ...
    def get_messages_for_prediction(self, limit: Optional[int] = None) -> List[EmailMessage]:
        ...
        unreviewed_messages = [
            msg for msg_id, msg in self.messages.items()
            if msg_id not in self.reviewed_messages
        ]
    ...
    def add_test_message(self, message: EmailMessage, is_reviewed: bool = False, review_label: str = None):
        """Add a test message."""
        self.messages[message.id] = message
...
class MockModel(ModelInterface):
    ...
    def __init__(self):
        ...
        self.prediction_map = {
            ...
            "work email": ("Work", 0.85),
            "personal email": ("Personal", 0.80),
        }
    ...
    def train(self, training_data: List[Tuple[str, str]], epochs: int = 6, batch_size: int = 64) -> TrainingMetrics:
