...
def configure_dependencies_for_production():
    ...
    from adapters import (
        GmailApiAdapter, DatabaseAdapter, FileSystemAdapter,
        ModelAdapter, TextProcessorAdapter, ConfigurationAdapter, LoggerAdapter
    )
...
def configure_dependencies_for_testing():
    ...
    from test_mocks import (
        MockGmailApi, MockDatabase, MockFileSystem, 
        MockModel, MockTextProcessor, MockConfiguration, MockLogger
    )
